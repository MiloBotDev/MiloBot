...
public enum PlayingCard {
    ...
    ACE_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_ACE.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.ACE),
    TWO_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_TWO.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.TWO),
    THREE_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_THREE.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.THREE),
    FOUR_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_FOUR.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.FOUR),
    FIVE_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_FIVE.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.FIVE),
    SIX_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_SIX.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.SIX),
    SEVEN_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_SEVEN.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.SEVEN),
    EIGHT_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_EIGHT.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.EIGHT),
    NINE_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_NINE.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.NINE),
    TEN_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_TEN.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.TEN),
    JACK_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_JACK.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.JACK),
    QUEEN_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_QUEEN.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.QUEEN),
    KING_OF_DIAMONDS(String.format("%s\n%s", CustomEmoji.RED_KING.getEmoji(), CustomEmoji.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.KING),
    ACE_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_ACE.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.ACE),
    TWO_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_TWO.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.TWO),
    THREE_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_THREE.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.THREE),
    FOUR_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_FOUR.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.FOUR),
    FIVE_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_FIVE.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.FIVE),
    SIX_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_SIX.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.SIX),
    SEVEN_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_SEVEN.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.SEVEN),
    EIGHT_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_EIGHT.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.EIGHT),
    NINE_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_NINE.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.NINE),
    TEN_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_TEN.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.TEN),
    JACK_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_JACK.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.JACK),
    QUEEN_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_QUEEN.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.QUEEN),
    KING_OF_HEARTS(String.format("%s\n%s", CustomEmoji.RED_KING.getEmoji(), CustomEmoji.HEARTS.getEmoji()), Suit.HEARTS, Rank.KING),
