...
public enum PlayingCard {
    ...
    ACE_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_ACE.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.ACE),
    TWO_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_TWO.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.TWO),
    THREE_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_THREE.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.THREE),
    FOUR_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_FOUR.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.FOUR),
    FIVE_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_FIVE.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.FIVE),
    SIX_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_SIX.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.SIX),
    SEVEN_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_SEVEN.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.SEVEN),
    EIGHT_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_EIGHT.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.EIGHT),
    NINE_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_NINE.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.NINE),
    TEN_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_TEN.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.TEN),
    JACK_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_JACK.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.JACK),
    QUEEN_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_QUEEN.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.QUEEN),
    KING_OF_DIAMONDS(String.format("%s\n%s", CustomEmojis.RED_KING.getEmoji(), CustomEmojis.DIAMONDS.getEmoji()), Suit.DIAMONDS, Rank.KING),
    ACE_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_ACE.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.ACE),
    TWO_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_TWO.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.TWO),
    THREE_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_THREE.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.THREE),
    FOUR_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_FOUR.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.FOUR),
    FIVE_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_FIVE.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.FIVE),
    SIX_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_SIX.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.SIX),
    SEVEN_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_SEVEN.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.SEVEN),
    EIGHT_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_EIGHT.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.EIGHT),
    NINE_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_NINE.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.NINE),
    TEN_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_TEN.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.TEN),
    JACK_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_JACK.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.JACK),
    QUEEN_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_QUEEN.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.QUEEN),
    KING_OF_HEARTS(String.format("%s\n%s", CustomEmojis.RED_KING.getEmoji(), CustomEmojis.HEARTS.getEmoji()), Suit.HEARTS, Rank.KING),
