...
public class NewBugReportCmd extends SubCommand implements TextCommand, SlashCommand, DefaultFlags, DefaultCommandArgs, DefaultChannelTypes, EventListeners {
    ...
    public NewBugReportCmd(@NotNull ExecutorService executorService) {
